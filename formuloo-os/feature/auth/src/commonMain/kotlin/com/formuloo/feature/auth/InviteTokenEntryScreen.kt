...
fun InviteTokenEntryScreen(
    ...
    Column(
        ...
        Text("J'ai reçu une invitation", style = MaterialTheme.typography.displayLarge)
        Spacer(Modifier.height(8.dp))
        Text(
            "Saisissez le code à 6 chiffres reçu par email pour rejoindre votre organisation.",
