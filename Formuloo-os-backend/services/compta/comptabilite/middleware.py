"""
Middlewares — Formuloo OS Service Compta
...
from comptabilite.authentication import ComptaJWTAuthentication
...
class TenantMiddleware:
    ...
    Enrichit request.user avec les données JWT :
        ...
        permissions  : permissions granulaires ['compta.read.ecritures', ...]
    ...
    def __call__(self, request):
        try:
            jwt_auth = ComptaJWTAuthentication()
