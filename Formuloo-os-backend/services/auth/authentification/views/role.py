...
class RolesListView(APIView):
    ...
    def get(self, request):
        # Les rôles système (is_system=True) sont globaux (tenant=None) — il faut les
        # inclure en plus des rôles personnalisés du tenant courant, sinon le dropdown
        # de sélection de rôle (invitation, assignation) reste vide.
